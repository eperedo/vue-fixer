(function(t, e) {
	...
	return (function(t) {
		...
		vgs7: function(t, e, n) {
			...
			var r = '//data.fixer.io/api';
			function o() {
				return { fixerData: { success: !1 } };
			}
			function i() {
				var t = this;
				this.fetching &&
			...
			var f = {
					...
					props: {
						...
						params: { type: String, default: '&base=EUR&symbols=USD,PEN' },
						protocol: { type: String, default: 'http' },
						fetching: { type: Boolean, default: !0 },
					},
					watch: { apiKey: c, feature: c, fetching: c, params: c },
				},
				u = function() {
					var t = this,
						e = t.$createElement,
						n = t._self._c || e;
					return n('div', [t._t('default', null, { fixer: t.fixerData })], 2);
				},
				s = [];
			function p(t, e, n, r, o, i, a, c) {
				t = t || {};
